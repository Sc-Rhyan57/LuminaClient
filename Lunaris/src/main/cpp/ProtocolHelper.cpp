...
static const std::vector<CodecInfo> protocols = {
        ...
        {897, "org/cloudburstmc/protocol/bedrock/codec/v1001/Bedrock_v1001"},
        { 1001, "org/cloudburstmc/protocol/bedrock/codec/v1001/Bedrock_v1001" },
};
...
Java_com_project_lumina_relay_listener_AutoCodecPacketListener_pickProtocolCodec(JNIEnv* env, jclass clazz, jint protocolVersion) {
    ...
    jclass defaultCodecClass = env->FindClass("org/cloudburstmc/protocol/bedrock/codec/v1001/Bedrock_v1001");
